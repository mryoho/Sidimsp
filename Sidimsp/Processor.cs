	...
	public class Processor
	{
		...
		public void StartSimulation() {
			...
			try {
				...
				for(int i = 0; i < 5; i++){ //While the cores have work to do, OR, more processes are to be created
					...
					for(int j = 0; j < _numCores; j++){
						if(_coreList[j].isFinishedProcessing()){
							Console.WriteLine ("Core " + j.ToString() + " is finished processing");	
						}
					}
